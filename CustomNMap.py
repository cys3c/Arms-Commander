...
class ScanParameters(object):
    ...
    def from_input(cls):
        return cls(
            ...
            scantype_Dict[str(raw_input("Enter a OPTION #: "))],
            ping_Dict[str(raw_input("Ping or no ping? YES OR NO, or 'Y' or 'N': "))],
...
os.system('cat /root/ArmsCommander/scantypes.txt\n\n')
